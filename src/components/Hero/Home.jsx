        ...
        <div className="container py-20 md:pb-40 mx-auto border-b border-b-slate-300 dark:border-none">
          <div className="flex flex-wrap md:justify-around md:items-center">
            <div className="w-full px-4 md:w-1/2">
              ...
              <p className="desc">
                Hallo senang kamu melihat halaman ini, belajar membuat web itu
                lumayan menantang, saya harap kamu suka dengan tema yang saya
                gunakan.
              </p>
              <a
                href="#about"
                className="text-base font-semibold bg-primary hover:bg-primaryMuda px-6 py-2.5 rounded-lg text-white hover:rounded-3xl block w-max transition-all duration-500 dark:bg-primaryMuda dark:hover:bg-primary"
              >
                Tentang Saya
              </a>
            </div>
